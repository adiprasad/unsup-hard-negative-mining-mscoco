...
class EditAnnotation(object):
	...
	def __init__(self, mode_year, category_id, hard_neg_dir, data_dir, dest_dir):
	...
	def __return_path_of_annotation_file(self):
		annotation_dir  = join(self.data_dir, 'coco/annotations')
		
		ann_file_name = "instances_{}.json".format(self.mode_year)
		ann_file_path = join(annotation_dir, ann_file_name)
...
def parse_args():
    ...
    parser.add_argument('--modeYear', dest='mode_year', help='Mode and year for e.g. train2014', default='train2014')
...
if __name__ == "__main__":
	...
	eann = EditAnnotation(args.mode_year, args.cat_id, args.hard_neg_dir, args.data_dir, args.dest_dir)
